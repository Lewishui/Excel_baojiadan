...
namespace QCAuto
{
    public partial class frmquanshengcailiao : Form
    {
        ...
        {
            string A_Path = AppDomain.CurrentDomain.BaseDirectory + "全晟新材料\\ip.txt";
        ...
        {
            string marcro = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "全晟新材料\\jxc.xlsm");
